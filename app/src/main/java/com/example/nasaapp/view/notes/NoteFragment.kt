...
class NoteFragment : Fragment() {
    ...
    private fun initNotes() {
        noteData = mutableListOf(
                Pair(DataNote("Earth", "description note one"), false),
                Pair(DataNote("Earth", "description note two"), false),
                Pair(DataNote("Earth", "description note three"), false),
                Pair(DataNote("Earth", "description note four"), false),
                Pair(DataNote("Earth", "description note five"), false)
        )
